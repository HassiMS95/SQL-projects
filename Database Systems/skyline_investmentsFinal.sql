...
('O1016', 'K. Sakaguchi', 'Ryan', '4440 Kukui Grove St', '96766', 'Lihue', 'HI'),
('O1017', 'Froelich', 'William', '74-577 Honokohau Street', '96740', 'Kailua Kona', 'HI'),
...
('O1021', 'R. Luther', 'Patrick', '500 N Carrollton Ave', '70119', 'New Orleans', 'LA'),
...
('B1011', 'Sandelin', 'Scott', '+17865227009', 'scott.sandelin@realestatefirm.com'),
('B1012', 'Hier', 'Nick', '+13036883105', 'nick.hier@investmentgroup.net'),
('B1013', 'Gartrell', 'Ryan', '+12394100', 'ryan.gartrell@propertiesllc.org'),
('B1014', 'Burpee', 'John', '+17275852070', 'john.burpee@realtycorp.net'),
('B1015', 'Romano', 'Robert', '+18136281952', 'robert.romano@brokerageco.com'),
('B1016', 'Sakaguchi (B)', 'Ryan K.', '+18085415172', 'ryan.sakaguchi@commercialrealty.org'),
('B1017', 'Froelich', 'William (Bill)', '+18086363999', 'bill.froelich@realestatedevelopment.com'),
('B1018', 'Baasch', 'Jeffrey', '+13122860141', 'jeffrey.baasch@investmentfirm.co'),
('B1019', 'Gableman', 'Ryan', '+15742642050', 'ryan.gableman@propertiesinc.com'),
('B1020', 'Cline', 'Aron', '+19494324509', 'aron.cline@realestateholdings.org'),
('B1021', 'R. Luther', 'Patrick', '+19496981115', 'patrick.luther@realtygroup.net'),
('B1022', 'Wood', 'Tony', '+19163901274', 'tony.wood@investmentcompany.co'),
('B1023', 'Nguyen', 'Thuy', '+17135301165', 'thuy.nguyen@brokerageinc.net');
...
('L0011', '7407 East 36th Avenue', 'P1011', 'B1011', 0),
('L0012', '514 Perry St.', 'P1012', 'B1012', 0),
('L0013', '111 E. Bridgers Ave', 'P1013', 'B1013', 0),
('L0014', '405 S Cirus Ave', 'P1014', 'B1014', 1),
('L0015', '1207 N. Himes Ave & 3418 W. Arch Street', 'P1015', 'B1015', 2),
('L0016', '4440 Kukui Grove St', 'P1016', 'B1016', 1),
('L0017', '74-577 Honokohau Street', 'P1017', 'B1017', 2),
('L0018', '7500 S South Shore Dr', 'P1018', 'B1018', 1),
('L0019', '502 S Oakland Ave', 'P1019', 'B1019', 2),
('L0020', '3400 Veterans Memorial Blvd', 'P1020', 'B1020', 1),
('L0021', '500 N Carrollton Ave', 'P1021', 'B1021', 2),
('L0022', '9400 Brodie Ln', 'P1022', 'B1022', 1),
('L0023', '4075 Hollister Rd', 'P1023', 'B1023', 2);
...
('P1004', 'O1004', 'L0004', '1002 S. Walton Blvd', 'B1004', '23.92 AC', 'Land','1876', '23.92 total acres of land for sale on S Walton Boulevard in Bentonville.', '0', 4000000.00, 1),
('P1005', 'O1005', 'L0005', '5051 Warden Rd', 'B1005', '1.47 AC', 'Retail', '1989', 'Convenience Store and Gas Station with 9 pumps 2 diesel. Car wash. Financial Available with signed confidentiality agreement.', '1', 4000000.00, 1),
('P1006', 'O1006', 'L0006', '9300 E Rita Rd', 'B1006', '1.24 AC', 'Office', '2004', '100% leased NNN medical building on 1.24 acres and 3.74 adjacent acres with approved development plan for 31,000 SF in seven buildings.', '1', 3600000.00, 1),
('P1007', 'O1007', 'L0007', '4690 N Oracle', 'B1007', '5.15 AC', 'Office', '2015', 'The building was converted from retail to office in 2015 for Comcast Cable. The Tucson Galleria, at 4690 N. Oracle Road, was constructed in the mid-1980s and operated as a multi-tenant retail mall initially.', '4', 34339000.00, 1),
('P1008', 'O1008', 'L0008', '745 N Dobson Rd', 'B1008', '58.95 AC', 'Multifamily', '1965', 'Investment 62 CONDO Portfolio bulk offering of sixty-two condominiums provides an investor with a high occupancy, fee simple condo home bulk package with low HOA fees.', '1', 8000000.00, 62),
('P1009', 'O1009', 'L0009', '470 Boynton Ave', 'B1009', '1.09 AC', 'Multifamily', '1968', 'The Orleans Apartments is well-maintained 40-unit complex consisting of (28) oversized 1+1s; (8) 2+1.5 flats, (3) 2+1.5 THS; and (1) 4+2 THS apartment units', '2', 15000000.00, 40),
('P1010', 'O1010', 'L0010', '777 W Orangethorpe Ave', 'B1010', '118,366 SF', 'Retail', '1986', 'Paul Kott Realtors, Inc.', '1', 8995000.00, 1),
